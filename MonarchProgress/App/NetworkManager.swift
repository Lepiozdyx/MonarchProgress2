...
class NetworkManager: ObservableObject {
    @Published private(set) var monarchURL: URL?
    
    static let iURL = URL(string: "https://monarchprogress.pro/view")!
    ...
    func checkInitialURL() async throws -> Bool {
        ...
        var request = URLRequest(url: Self.iURL)
...
struct WKWebViewManager: UIViewRepresentable {
    class Coordinator: NSObject, WKNavigationDelegate {
        ...
        func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            ...
            if finalURL != NetworkManager.iURL {
